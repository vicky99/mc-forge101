...
public class BiggerTNTExplosions {
	...
	public void spawnTNTItem(EntityJoinWorldEvent event){
		...
		EntityItem explosion = new EntityItem(event.world, entity.posX, entity.posY, entity.posZ,
	...
	public void explosion (ItemExpireEvent event) {
		...
		event.entity.worldObj.createExplosion(explosion, explosion.posX, explosion.posY, explosion.posZ, power, true);
	}
